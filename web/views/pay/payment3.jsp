...
<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <% ArrayList<Pay> list= (ArrayList<Pay>)request.getSession().getAttribute("list"); %>	
...
<tr>
  ...
  <table class="serviceTable">
     ...
     <tbody>
     <tr style="background:#dddddd; "border:1px solid gray";>
     
     <% for(Pay p : list){		%>
        <td><p align="center">공유명</td>
        <td><p align="center">수량</td>
        <td><p align="center">가격 </td>
     </tr>
  <!-- 구매할 리스트  Start -->

	<tr><td><%= p.getP_name() %></td>
		<td><%= p.getP_count() %>개</td>
		<td><%= p.getPay_price() %>원</td>
	</tr>
     ...
     <tr id="rst1">
         <td colspan="1" class="title"><p align="center">총 주문금액</td>
     	 <th></th>
         <th colspan="1"><p align="center"><%= p.getTotal_price() %>원</p></th>
          
        <!--  th class="total"><p align="center"></p></th>-->
      </tr>
          <% }		%> 
      <% }		%>
