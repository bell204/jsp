...
<body>
 ...
 <% for(product p : list) {%>
            ...
            <div class="price" style="float: right; ">
               ...
               <div class="price_box m_top15 co2fa0ee bgnone" id="record_status">입금완료</div>	 
            								 <%} %>
            								 
            								  <% if(p.getP_share_count() ==1){ %>
               <div class="price_box m_top15 co2fa0ee bgnone" id="record_status">입금대기</div>	 
            								 <%} %>
     
      			 <% if(p.getP_share_count() ==3){ %>
               <div class="price_box m_top15 co2fa0ee bgnone" id="record_status">공유완료</div>	 
            								 <%} %>
     
     		<% if(p.getP_share_count() ==4){ %>
               <div class="price_box m_top15 co2fa0ee bgnone" id="record_status">거래완료</div>	 
            								 <%} %>
     
     	<% if(p.getP_share_count() ==5){ %>
               <div class="price_box m_top15 co2fa0ee bgnone" id="record_status">수정요청</div>	 
            								 <%} %>
            								 
            								 <% if(p.getP_share_count() ==6){ %>
               <div class="price_box m_top15 co2fa0ee bgnone" id="record_status">구매취소</div>	 
            								 <%} %>
            								 
            								  <% if(p.getP_share_count() ==7){ %>
               <div class="price_box m_top15 co2fa0ee bgnone" id="record_status">판매취소</div>	 
            								 <%} %>
