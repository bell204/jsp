...
<body>
	...
	<div id="A_Container_Wrap">
		<div id="A_Container">
			...
			<div id="A_Contents_C">
				...
				<div class="sb_contents font_contents2" style=margin:20px;>
				...
				<div class="board_search">
					...
					<!-- 검색 -->
					<form id="searchForm" action="<%=request.getContextPath() %>/searchRequestEngine.do" name="searchForm" method="post" align="right">
						<p>
	
						 <select id="keyword" name="keyword">
								<option name="p_name" id="p_name" value="p_name">공유명</option>
								 
							</select> 
							<input type="text" name="search3" id="search3" style="width:150px" value=""> 
							  <input type="submit" id="searchBtn1" style="width:70px"  value="검색"/>
							 </p>
					</form>
				 <br>
	 ...
	 <script>
	 <%--var p_name= $("#keyword option:eq(1)").val();
     ...
     if($("#search3").click()){
    	 ...
    	 if("#p_name selected"){
    	 location.href="<%=request.getContextPath() %>/searchRequestEngine.do?search3="+search3
    	 }else{
    	 location.href="<%=request.getContextPath() %>/searchRequestEngine1.do?search3="+search3
    	 }   
     }
  ...
  --%>
					...
					<table class="serviceTable inquiry_list" cellpadding="0"
						...
						<thead>
							<tr>
								...
								<th align="left"><p>재능요청명</p></th>
								<th><p>아이디</p></th>
								<th><p align="center">등록시간</p></th>
								<th><p align="center">희망가격</p></th>
							</tr>
						</thead>
						<tbody>
   ...
   <div class="pagingArea" align="center" style=padding:20px;>
