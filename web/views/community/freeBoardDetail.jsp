...
<%@ include file="../common/header.jsp"%>
	<div id='A_Container_Wrap'>
		<div id='A_Container'>
			...
			<br>
			<% if(loginUser !=null && n.getC_code().equals(loginUser.getC_code())){ %>
			<div align="center" class="bttomBtns">
			<button onclick="location.href='/p/views/community/freeBoardUpdate.jsp'">수정하기</button>
			<button onclick="location.href='<%= request.getContextPath()%>/deleteFreeBoard?com_code=<%=n.getCom_code()%>'">삭제하기</button> 
			</div>
			<%} %>
			</div>
</div></div>
