...
<div id='A_Container_Wrap'>
		<div id='A_Container'>
		   ...
		   <div class="ChangeContainer">
            <h1 style="margin-left: 0px;" class="bor_btm266 m_bottom20">프로필</h1>
            <form action="<%= request.getContextPath() %>/insertProfileImg?userId=<%= loginUser.getC_id() %>" method="post" encType="multipart/form-data">
               <div class="changePhoto">
               
				<% if(profilImg != null){%>
                     <img id="profileImg" class="img-circle" alt="사진불러와" width="120" height="120"
                     src="/p/profile_Images/<%= file.getSec_file_name()%>"> 
			...
			<!-- 1 -->
               ...
               <div>
               	<table class="person_change board_write" cellspacing="0">
					...
					<th>공유분야 *</th>
						<td>
						  <select name="shareType" class="selectShareType" readonly>
      				...
      				<tr>
						<th>소개제목 *</th>
						<td><input class="w400px" type="text" name="intro_title" value="<%= c.getIntro_title() %>" readonly></td>
					</tr>
      				<tr>
						<th>자격증 *</th>
						<td><input style="width:180px;"type="text" value="<%= c.getCerti_name() %>" name="certifi_name" readonly></td>
					</tr>
					<tr>
						<th>주요경력</th>
						<td><textarea name="career" style="resize:none;" value="<%= c.getCareer() %>" readonly></textarea></td>
					</tr>
					<tr>
						<th>자기소개 *</th>
						<td><textarea name="introduce" style="resize:none;" value="<%=c.getIntroduce() %>" readonly></textarea></td>
						</tr>
